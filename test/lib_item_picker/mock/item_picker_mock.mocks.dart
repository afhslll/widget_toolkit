...
class _FakeItemPickerBlocEvents_0 extends _i1.SmartFake
  ...
  _FakeItemPickerBlocEvents_0(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeItemPickerBlocStates_1<T1> extends _i1.SmartFake
    implements _i2.ItemPickerBlocStates<T1> {
  _FakeItemPickerBlocStates_1(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockItemPickerBlocStates<T> extends _i1.Mock
  ...
  @override
  _i3.Stream<_i4.Result<List<T>>> get items =>
      (super.noSuchMethod(
...
class MockItemPickerBlocType<T> extends _i1.Mock
  ...
  @override
  _i2.ItemPickerBlocEvents get events =>
      (super.noSuchMethod(
  ...
  @override
  _i2.ItemPickerBlocStates<T> get states =>
      (super.noSuchMethod(
