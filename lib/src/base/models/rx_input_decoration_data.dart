...
class RxInputDecorationData {
  ...
  const RxInputDecorationData({
    ...
    this.iconCounterDecrement = const Icon(Icons.remove),
    this.iconCounterIncrement = const Icon(Icons.add),
  });
  ...
  final Widget iconCounterDecrement;
  final Widget iconCounterIncrement;
}
