...
String convertRemainingTime(
  int time,
  CountdownTimeFormat timeFormat,
  bool preferDoubleDigitsForTime,
) {
  String output = '';
  ...
  switch (timeFormat) {
    case CountdownTimeFormat.minutes:
      ...
      final minOut = preferDoubleDigitsForTime
    ...
    case CountdownTimeFormat.hours:
      ...
      final hoursOut = preferDoubleDigitsForTime
          ? _formatToDoubleDigitValue(hours)
          : hours;
      output =
          '$hoursOut'
          ':${_formatToDoubleDigitValue(mins)}'
