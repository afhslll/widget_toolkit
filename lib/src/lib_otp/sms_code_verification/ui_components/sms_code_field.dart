...
import '../../models/temporary_code_state.dart';
import '../../utils/enums.dart' as enums;
import '../../theme/sms_code_theme_configuration.dart';
...
class _SmsCodeFieldState extends State<SmsCodeField> {
    ...
    switch (widget.androidSmsAutofillMethod) {
      ...
      case enums.AndroidSmsAutofillMethod.smsUserConsentApi:
        return SmsRetrieverImpl(
          ...
          useUserConsentAPI:
              enums.AndroidSmsAutofillMethod.smsUserConsentApi ==
  ...
  Widget _buildPinField(
    ...
    separatorBuilder: (_) =>
        widget.separator ??
        SizedBox(width: context.widgetToolkitTheme.spacings.xs),
    cursor:
        widget.cursor ??
        Container(
          width: 1.1,
  ...
  PinTheme _buildFocusedTheme(BuildContext context) =>
      ...
      : _buildGenericTheme(context, showBorder: true);
