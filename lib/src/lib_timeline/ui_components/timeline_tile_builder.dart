...
enum ContentsAlign { basic, reverse, alternating }

enum ConnectionDirection { before, after }

enum ConnectorType { start, end }

enum IndicatorStyle { dot, outlined, container, transparent }

enum ConnectorStyle { solidLine, dashedLine, transparent }
