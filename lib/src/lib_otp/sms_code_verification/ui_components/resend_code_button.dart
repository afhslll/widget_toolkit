...
class ResendCodeButton extends StatelessWidget {
  ...
  final ToolkitButtonStyle? buttonColorStyle;
  ...
  Widget _buildWithDependencies(
    ...
    builder: (context, codeState, bloc) {
      ToolkitButtonState? globalState =
          (codeState.hasData && codeState.data == TemporaryCodeState.correct)
      ...
      return RxResultBuilder<SmsCodeBlocType, bool>(
        ...
        buildSuccess: (context, isEnabled, bloc) =>
            RxBlocBuilder<SmsCodeBlocType, bool>(
              ...
              builder: (context, isSent, bloc) =>
                  (isSent.hasData && isSent.data!)
                  ? _buildResendButton(
                      context,
                      onPressed: onPressed,
                      label:
                      ...
                      iconColor:
                          context.smsCodeTheme.resendButtonSuccessTextColor,
                      currentState: globalState ?? ToolkitButtonState.pressed,
                    )
                  : _buildResendButton(
                      context,
                      onPressed: () {
                      ...
                      iconColor:
                          (globalState != ToolkitButtonState.disabled &&
                              isEnabled)
                          ? context.smsCodeTheme.resendButtonActiveTextColor
                          : context.smsCodeTheme.resendButtonDisabledTextColor,
                      currentState:
        ...
        buildLoading: (context, bloc) => _buildResendButton(
          context,
          onPressed: null,
          label:
              strings?.sendNewCode ?? context.getLocalizedStrings.sendNewCode,
          textColor: context.smsCodeTheme.resendButtonDisabledTextColor,
          currentState: globalState ?? ToolkitButtonState.loading,
        ...
        buildError: (context, error, bloc) => _buildResendButton(
          ...
          currentState: globalState ?? ToolkitButtonState.enabled,
        ),
        // ),
      );
    },
  ...
  Widget _buildResendButton(
    ...
    Color? textColor,
    Color? iconColor,
    required ToolkitButtonState currentState,
